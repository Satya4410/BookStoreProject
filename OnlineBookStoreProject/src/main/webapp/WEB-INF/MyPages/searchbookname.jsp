...
<form method="POST" action="searbookname" onsubmit="return book()">
<table style="width:50%;text-align:right;margin-left:100px;">
<br/><br/>
<tr>
<td class="div1">Book Title :</td>
<td><input class="div" placeholder="Enter Book Title" type="text" name="title" id="bname" value=""/></td>
