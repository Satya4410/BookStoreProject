...
<fm:form action="loginProcess"  onsubmit="return fun()" method="POST" modelAttribute="user" enctype="multipart/form-data">
<div class="container">
    <div class="row">
        <div class="col-md-offset-5 col-md-4 text-center">
              ...
              <h4>LOGIN HERE</h4>
                ...
                <fm:input type="text" path="Email" id="eml" value="" class="form-control input-sm chat-input" placeholder="Email Id"/>
